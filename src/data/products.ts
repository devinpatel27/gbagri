export const products = [
    {
        ...
        benefits: [
            ...
            'Large, uniform kernel size',
            'Long shelf life when stored correctly',
            'Ideal for premium snacking and roasting'
        ],
        specifications: [
    ...
    },
    {
        ...
        benefits: [
            'Ready to use for culinary applications',
            'No bitter skin aftertaste',
            'High oil density perfect for peanut butter',
            'Saves processing time for manufacturers'
        ],
        specifications: [
            { label: 'Origin', value: 'Gujarat, India' },
    ...
    },
    {
        ...
        benefits: [
            'Exceptional aroma and strong flavor',
            'High essential volatile oil content',
            'Known to aid digestion',
            '99.5% minimum purity guarantee'
        ],
        specifications: [
    ...
    },
    {
        ...
        benefits: [
            ...
            'Sweet, distinct aromatic profile',
            'Available in varied color grades (Green to Pale)'
        ],
        specifications: [
            { label: 'Origin', value: 'Gujarat, India' },
            { label: 'Purity', value: '99%, 99.5% Sortex' },
            { label: 'Moisture', value: '10% Max' },
            { label: 'Flavor', value: 'Aromatic, Sweet' },
    ...
    },
    {
        ...
        benefits: [
            ...
            'Mechanically hulled for cleaner finish',
            'Perfect for tahini and bakery products',
            'Strictly checked for salmonella and pathogens'
        ],
        specifications: [
            { label: 'Origin', value: 'Gujarat/UP, India' },
            { label: 'Type', value: 'Natural, Hulled, Black' },
            { label: 'Purity', value: '99.9% Premium Sortex' },
            { label: 'Moisture', value: '5% Max' },
            { label: 'FFA (Free Fatty Acid)', value: 'Max 2%' }
        ]
    },
    {
        ...
        benefits: [
            ...
            'Great binding capacity for batters',
            'Available in polished and unpolished options',
            'Farm-fresh color and quick cooking time'
        ],
        specifications: [
            { label: 'Origin', value: 'Madhya Pradesh/Gujarat, India' },
            { label: 'Variants', value: 'Whole (Urad Gota), Split (Chilka), Split Skinless' },
            { label: 'Moisture', value: '12% Max' },
            { label: 'Foreign Matter', value: '1% Max' },
            { label: 'Weevilled Seed', value: 'Max 2%' }
        ]
    }
];
